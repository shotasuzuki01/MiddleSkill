public class test1 {
	public static void main(String[] args) {
		...
		int numb = 5;
		String result = numb > 0 ? "positive" : numb == 0 ? "zero" : "negative";
		...
		intResult = numc > numd ? numc : numc < numd ? numd : numc;
		...
		int numf = 3;
		String results = "";
		results = nume < 0 && numf > 0 ? "one positive"
				: nume > 0 && numf < 0 ? "one positive"
						: nume > 0 && numf > 0 ? "both positive" : nume < 0 && numf < 0 ? "both negative" : "etc";
